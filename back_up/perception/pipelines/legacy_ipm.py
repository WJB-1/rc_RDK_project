...
如需新代码，请直接 import:
  ...
  from perception.algorithms.lane_analyzer import analyze_bev_lane_state, get_last_valid_state
  from perception.algorithms.quality_gate import validate_frame_quality
  from perception.algorithms.crossroad_detect import detect_crossroad, reset_crossroad_counter
...
from perception.algorithms.ipm import MathematicalIPM
from perception.algorithms.lane_analyzer import (
    analyze_bev_lane_state, get_last_valid_state,
    reset_drop_counter, _empty_lane_state,
)
from perception.algorithms.quality_gate import validate_frame_quality
from perception.algorithms.crossroad_detect import (
...
# 保留兼容别名
from perception.algorithms.lane_analyzer import _empty_lane_state as empty_lane_state
_validate_frame_quality = validate_frame_quality
_detect_crossroad_duty_cycle = detect_crossroad
from perception.diagnostics.ipm_drawer import draw_debug_panel as draw_debug_panel_math_ipm
