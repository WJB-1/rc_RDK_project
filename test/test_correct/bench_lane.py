...
def main() -> int:
    ...
    for label, stage_name in (
        ...
        ("  DP path", "lane.template_dp_path"),
        ("  candidate eval", "lane.template_candidate_eval"),
        ("    fit/loss", "lane.template_candidate_fit"),
        ("    corridor check", "lane.template_corridor_check"),
        ("  loop overhead", "lane.template_dp_loop_overhead"),
